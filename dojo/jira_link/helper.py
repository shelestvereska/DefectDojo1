...
def get_jira_project(obj, use_inheritance=True):
    ...
    if isinstance(obj, JIRA_Issue):
        ...
        elif hasattr(obj, 'finding') and obj.finding or hasattr(obj, 'engagement') and obj.engagement:
...
def get_jira_creation(obj):
    if isinstance(obj, (Finding, Engagement, Finding_Group)) and obj.has_jira_issue:
...
def issue_from_jira_is_active(issue_from_jira):
    ...
    if issue_from_jira.fields.resolution == "None":  # noqa: SIM103
        return True
